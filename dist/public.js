...
const isCleanBCPluginActive = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.qs)('script[src*="/plugins/bcgov-plugin-cleanbc/dist/assets/public"]') !== null;
...
const bcgovBlockThemeSinglePost = () => {
  ...
  window.requestAnimationFrame(() => {
     ...
     */
    const body = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.qs)('.single-post');
    if (body) {
      /**
       ...
       */
      const headerGroup = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.qs)('.bcgov-header-container');
      const content = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.qs)('.bcgov-body-content');
      if (headerGroup && content) {
        const headerGroupHeight = window.getComputedStyle(headerGroup).getPropertyValue('height');
        console.log(headerGroupHeight);
        content.style.minHeight = "calc(100dvh - " + headerGroupHeight + ")";
...
if ('complete' === document.readyState) {
  ...
  (0,_utils__WEBPACK_IMPORTED_MODULE_0__.addSafeEventListener)(document, 'DOMContentLoaded', bcgovBlockThemeSinglePost());
}
...
/* harmony import */ var _single__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./single */ "./src/scripts/public/single.js");
/* harmony import */ var _accessibility__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./accessibility */ "./src/scripts/public/accessibility.js");
/* harmony import */ var _notification_banner__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./notification-banner */ "./src/scripts/public/notification-banner.js");
/* harmony import */ var _print__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./print */ "./src/scripts/public/print.js");
/* harmony import */ var _takeover_navigation__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./takeover-navigation */ "./src/scripts/public/takeover-navigation.js");
/* harmony import */ var _ribbon_navigation__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./ribbon-navigation */ "./src/scripts/public/ribbon-navigation.js");
/* harmony import */ var _alpha_v3_search__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./alpha-v3/search */ "./src/scripts/public/alpha-v3/search.js");
/* harmony import */ var _admin_blocks_collapse_app__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../admin/blocks/collapse/app */ "./src/scripts/admin/blocks/collapse/app.js");
/**

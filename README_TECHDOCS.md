[![Package Status](https://github.com/bcgov/bcgov-wordpress-block-theme/actions/workflows/publish.yaml/badge.svg)](https://github.com/bcgov/bcgov-wordpress-block-theme/actions/workflows/publish.yaml)
...
The homepage of your documentation is in the [documentation /docs/index.md](documentation /docs/index.md) file. Edit it to suit your usage. Warning: do not delete this file. 

Add documentation pages by  adding more markdown (.md) files to the [docs](documentation /docs) folder.

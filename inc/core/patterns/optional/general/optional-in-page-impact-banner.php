...
return [
	...
	<h2 class="has-background-color has-text-color"><strong>Fusce dapibus, tellus ac cursus commodo</strong>.</h2>
	<!-- /wp:heading -->
	
	<!-- wp:paragraph {"textColor":"background","fontSize":"extra-small"} -->
	<p class="has-background-color has-text-color has-extra-small-font-size">Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor.</p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-button is-style-underline"><a class="wp-block-button__link has-background-color has-primary-brand-alt-background-color has-text-color has-background">Learn more about cursus commodo</a></div>
	<!-- /wp:button --></div>
	<!-- /wp:buttons --></div>
	<!-- /wp:group --></div></div>
	<!-- /wp:media-text --></div>

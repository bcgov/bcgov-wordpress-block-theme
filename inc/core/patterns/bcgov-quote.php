...
return array(
	...
	'content'    => '<!-- wp:group {"style":{"spacing":{"padding":{"top":"6rem","bottom":"6rem","right":"6rem","left":"6rem"},"blockGap":"3rem"},"border":{"style":"solid","width":"2px"}},"borderColor":"primary-brand","className":"is-quote"} -->
	<div class="wp-block-group is-quote has-border-color has-primary-brand-border-color" style="border-style:solid;border-width:2px;padding-top:6rem;padding-right:6rem;padding-bottom:6rem;padding-left:6rem"><!-- wp:columns -->

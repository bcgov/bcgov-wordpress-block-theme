...
return [
	...
	<div class="wp-block-media-text alignwide is-stacked-on-mobile is-img-rounded is-style-square has-accent-stroke has-white-color has-primary-brand-background-color has-text-color has-background has-link-color" style="margin-top:6rem;margin-bottom:6rem;padding-top:0;padding-bottom:0;grid-template-columns:40% auto"><figure class="wp-block-media-text__media"><img src="' . esc_url( get_template_directory_uri() ) . '/assets/images/block-theme/default_playing_with_abacus.jpg" alt="Playing with Abacus" class="wp-image-1467 size-full"/></figure><div class="wp-block-media-text__content"><!-- wp:image {"id":3602,"width":"120px","sizeSlug":"full","linkDestination":"none","className":"icon"} -->
	...
	<p style="font-size:1.15rem">Cras justo odio, dapibus ac facilisis in, egestas eget quam. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ullamcorper nulla non metus auctor fringilla. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Maecenas sed diam eget risus varius blandit sit amet non magna. Donec id elit non mi porta gravida at eget metus. Cras justo odio, dapibus ac facilisis in, egestas eget quam.</p>
	<!-- /wp:paragraph --></div>
	<!-- /wp:group --></div><figure class="wp-block-media-text__media"><img src="' . esc_url( get_template_directory_uri() ) . '/assets/images/block-theme/default_modern_condos.jpg" alt="Modern Condos" class="wp-image-3622 size-full"/></figure></div>
	<!-- /wp:media-text -->
	...
	<div class="wp-block-media-text alignwide is-stacked-on-mobile is-img-rounded is-style-square has-accent-stroke has-white-color has-primary-brand-background-color has-text-color has-background has-link-color" style="margin-top:6rem;margin-bottom:6rem;grid-template-columns:40% auto"><figure class="wp-block-media-text__media"><img src="' . esc_url( get_template_directory_uri() ) . '/assets/images/block-theme/default_piggy_back_ride.jpg" alt="Piggy Back Ride" class="wp-image-4547 size-full"/></figure><div class="wp-block-media-text__content"><!-- wp:image {"id":3612,"width":"120px","sizeSlug":"full","linkDestination":"none","className":"icon"} -->

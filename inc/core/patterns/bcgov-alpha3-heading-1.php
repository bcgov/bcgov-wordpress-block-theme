...
return [
	...
	'content'    => '<!-- wp:group {"align":"full","style":{"background":{"backgroundImage":{"url":"' . esc_url( get_template_directory_uri() ) . '/assets/images/block-theme/default_01.jpg","id":157,"source":"file","title":"vancouver-257722_1920"}}},"layout":{"type":"default"}} -->
	...
	<figure class="wp-block-image size-full is-resized"><img src="' . esc_url( get_template_directory_uri() ) . '/assets/images/block-theme/Folder-5.png" alt="Folder Icon with a Lock" class="wp-image-572" style="width:auto;height:150px" title=""/></figure>
	<!-- /wp:image --></div>
	<!-- /wp:group --></div>
	<!-- /wp:group --></div>
	<!-- /wp:group -->',

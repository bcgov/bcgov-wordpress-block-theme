...
return array(
	...
	'content'    => '<!-- wp:media-text {"mediaPosition":"right","mediaId":305,"mediaLink":"' . esc_url( get_template_directory_uri() ) . '/assets/images/block-theme/default_10.jpg","mediaType":"image","verticalAlignment":"center","imageFill":false,"style":{"color":{"gradient":"linear-gradient(270deg,rgba(192,186,217,0) 38%,rgba(195,189,219,0.66) 38%,rgba(192,186,217,0.66) 91%)"}}} -->
	...
	<!-- wp:media-text {"mediaId":305,"mediaLink":"' . esc_url( get_template_directory_uri() ) . '/assets/images/block-theme/default_10.jpg","mediaType":"image","verticalAlignment":"center","style":{"color":{"gradient":"linear-gradient(90deg,rgba(192,186,217,0) 38%,rgba(195,189,219,0.66) 38%,rgba(192,186,217,0.66) 91%)"}}} -->

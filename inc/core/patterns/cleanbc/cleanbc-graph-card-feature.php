...
return [
	...
	<h2>Measuring pollution&nbsp;</h2>
	<!-- /wp:heading -->
	
	<!-- wp:paragraph {"fontSize":"extra-small"} -->
	<p class="has-extra-small-font-size">In B.C. we measure air pollution from different types of human activity. This helps us understand where the pollution comes from and where we can work to reduce it.</p>
	<!-- /wp:paragraph -->
	
	<!-- wp:paragraph -->
	<p>In 2007, B.C.’s air pollution from greenhouse gases totalled 65.6 million tonnes. We have a plan to reduce greenhouse gas pollution by 40% by 2030.</p>
	<!-- /wp:paragraph -->
	
	<!-- wp:paragraph -->
	<p>Data from the provincial inventory.&nbsp;</p>
	<!-- /wp:paragraph --></div>
	<!-- /wp:group --></div></div>
	<!-- /wp:media-text --></div>
	<!-- /wp:group -->',

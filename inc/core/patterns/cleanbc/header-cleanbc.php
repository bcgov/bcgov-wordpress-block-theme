...
return [
	...
	'categories' => [ 'bcgov-blocks-theme-patterns-cleanbc' ],
	...
	<div class="wp-block-group bcgov-header-group has-border-color has-primary-brand-alt-border-color has-white-color has-primary-brand-background-color has-text-color has-background has-link-color" style="padding-top:0px;padding-right:65px;padding-bottom:0px;padding-left:65px"><!-- wp:columns {"align":"wide"} -->
	...
	<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%"><!-- wp:navigation {"ref":52,"textColor":"white","overlayMenu":"always","overlayBackgroundColor":"primary-brand","overlayTextColor":"white","layout":{"type":"flex","justifyContent":"center","orientation":"horizontal","flexWrap":"wrap"},"style":{"spacing":{"blockGap":"1rem"}},"fontSize":"large"} /--></div>
	<!-- /wp:column --></div>
	<!-- /wp:columns --></div>
	<!-- /wp:group -->',
];

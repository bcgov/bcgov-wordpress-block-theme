...
return [
	...
	<div class="wp-block-media-text alignwide is-stacked-on-mobile is-style-default" style="grid-template-columns:65% auto"><figure class="wp-block-media-text__media"><img src="' . esc_url( get_template_directory_uri() ) . '/assets/images/sites/cleanbc/cleanbc-on-this-page-placeholder.jpg" alt="" class="wp-image-1621 size-full"/></figure><div class="wp-block-media-text__content"><!-- wp:heading {"level":3} -->
	<h3>On this page</h3>
	<!-- /wp:heading -->

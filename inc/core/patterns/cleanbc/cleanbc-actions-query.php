...
return [
	...
	<div class="wp-block-group alignwide is-actions-query-loop" style="margin-top:3rem;margin-bottom:3rem"><!-- wp:heading {"align":"wide"} -->
	...
	<!-- wp:query {"queryId":2,"query":{"offset":0,"postType":"post","order":"asc","orderBy":"date","author":"","search":"","sticky":"","perPage":12,"inherit":false,"taxQuery":{"category":[21]}},"displayLayout":{"type":"list","columns":3},"align":"wide","layout":{"inherit":true}} -->
	<div class="wp-block-query alignwide"><!-- wp:post-template {"align":"wide"} -->
	<!-- wp:columns {"style":{"color":{"background":"#f1f1f180"}}} -->
	...
	<!-- wp:column {"verticalAlignment":"center","width":"75%","style":{"spacing":{"padding":{"top":"1rem","right":"3rem","bottom":"2rem","left":"3rem"}}}} -->
	<div class="wp-block-column is-vertically-aligned-center" style="padding-top:1rem;padding-right:3rem;padding-bottom:2rem;padding-left:3rem;flex-basis:75%"><!-- wp:post-title {"textColor":"tertiary"} /-->

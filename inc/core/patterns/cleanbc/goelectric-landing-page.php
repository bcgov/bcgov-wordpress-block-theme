...
return [
	...
	<!-- wp:cover {"url":"https://bcgov-block-theme.local/wp-content/uploads/2022/07/goElectricBC-shareable-01.jpg","id":306,"dimRatio":0,"customOverlayColor":"#000000","focalPoint":{"x":"0.49","y":"0.50"},"minHeight":50,"minHeightUnit":"vh","contentPosition":"center center","align":"full"} -->
	...
	<div class="wp-block-columns alignwide"><!-- wp:column {"width":"30%","style":{"spacing":{"padding":{"top":"2rem","right":"2rem","bottom":"2rem","left":"2rem"}},"color":{"background":"#003366d1"}}} -->
	<div class="wp-block-column has-background" style="background-color:#003366d1;padding-top:2rem;padding-right:2rem;padding-bottom:2rem;padding-left:2rem;flex-basis:30%"><!-- wp:heading {"align":"wide","style":{"typography":{"fontSize":"3rem","lineHeight":"1.2"}},"className":"alignwide has-white-color has-text-color"} -->
	<h2 class="alignwide has-white-color has-text-color" style="font-size:3rem;line-height:1.2">More and more people&nbsp;are<strong><em>&nbsp;</em>going electric</strong></h2>
	<!-- /wp:heading -->
	
	<!-- wp:paragraph {"style":{"color":{"text":"#ffffff"}},"fontSize":"normal"} -->
	<p class="has-text-color has-normal-font-size" style="color:#ffffff">Through our CleanBC plan, the Province is making clean transportation more affordable and accessible for British Columbians.</p>
	<!-- /wp:paragraph -->
	...
	<p style="font-size:3rem;line-height:1.2"><strong>Why go electric?</strong></p>
	<!-- /wp:paragraph -->
	
	<!-- wp:paragraph {"fontSize":"large"} -->
	<p class="has-large-font-size">You can save&nbsp;as much as $8,000 when purchasing an electric vehicle in B.C.</p>
	<!-- /wp:paragraph -->
	...
	<!-- wp:media-text {"mediaId":285,"mediaLink":"https://bcgov-block-theme.local/bcgov/kia-ev6-2022/","mediaType":"image","verticalAlignment":"center","style":{"color":{"background":"#cf2d2d14"}}} -->
	<div class="wp-block-media-text alignwide is-stacked-on-mobile is-vertically-aligned-center has-background" style="background-color:#cf2d2d14"><figure class="wp-block-media-text__media"><img src="https://bcgov-block-theme.local/wp-content/uploads/2022/07/kia-ev6-2022-1024x520.png" alt="" class="wp-image-285 size-full"/></figure><div class="wp-block-media-text__content"><!-- wp:group {"style":{"spacing":{"padding":{"top":"2em","right":"2em","bottom":"2em","left":"2em"}}}} -->
	<div class="wp-block-group" style="padding-top:2em;padding-right:2em;padding-bottom:2em;padding-left:2em"><!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.2","fontSize":"3rem"}}} -->
	<p style="font-size:3rem;line-height:1.2"><strong>Easier than ever to get around.</strong></p>
	<!-- /wp:paragraph -->
	
	<!-- wp:paragraph {"fontSize":"large"} -->
	<p class="has-large-font-size">Most modern EVs can meet the average commuter’s needs by plugging in just once or twice a week.</p>
	<!-- /wp:paragraph -->
